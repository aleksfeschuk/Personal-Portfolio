...
export const Resume = () => {
    return (
        ...
        >
            ...
            >
                With a background in Computer Science and hands-on experience in design and front-end development, I've worked on diverse projects ranging from landing pages to SaaS dashboards. Each project has strenghtened my focus on building clean, functional, and user-friendly digital experiences.
            </motion.p>
